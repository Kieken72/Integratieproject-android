        ...
        btnReserveren.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ("".equals(token)){
                    ...
                    FavoritesActivity startActivity = (FavoritesActivity) getActivity();
                    FavoritesReservationInfoFragment favoResInfo = new FavoritesReservationInfoFragment();

                    bundle.putInt("branchId", receivedBranchId);
                    bundle.putString("branchName",txtBranchName.getText().toString());

                    favoResInfo.setArguments(bundle);
                    startActivity.changeFragment(favoResInfo, 2);
                }
            }
        });
        return view;
